...
function loadAddon(id,src){if(document.getElementById(id))return;const s=document.createElement('script');s.id=id;s.async=false;s.src=src+'?v=11';document.body.appendChild(s)}
