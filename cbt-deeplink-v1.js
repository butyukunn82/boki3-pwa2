...
function go(){
 ...
 const names=page==='q2-cbt.html'?{closing:'商品売買・締切',dividend:'配当・法人税',asset:'固定資産台帳',accrual:'経過勘定',interest:'利息・経過勘定'}:{statements:'B/S・P/L',worksheet:'精算表',adjusted:'整理後残高試算表',comprehensive:'総合決算'};
...
let n=0;const t=setInterval(()=>{n++;if(go()||n>30)clearInterval(t)},60);
})();
