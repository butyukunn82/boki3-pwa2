const CACHE='boki3-unified-v3.0.2-audit-cbt';
const ASSETS=['./','./index.html','./daily.html','./learn.html','./questions.html','./coverage.html','./practical.html','./official-gaps.html','./q1-cbt.html','./welcome.html','./mock.html','./labs.html','./q1.html','./q2.html','./q3.html','./understand.html','./glossary.html','./management.html','./settings.html','./common.css','./mobile-app.css','./app-ui-v13.css','./app-v20.css','./unified.js','./settings-runtime.js','./settings-page.js','./dark-mode-fix.js','./contrast-mode-fix.js','./mastery.js','./mastery-native.js','./mastery-progress-v2.js','./coverage-wave2.js','./practical-wave3.js','./practical-sequence.js','./gap-sequence-v4.js','./mastery-coverage-patch.js','./mastery-practical-patch.js','./mastery-gap-patch-v4.js','./exam-scope-v2.js','./exam-scope-wave2-patch.js','./exam-scope-wave3-patch.js','./official-topic-master-v4.js','./exam-readiness.js','./cbt-readiness-v4.js','./error-diagnostics-v1.js','./diagnostics-ui-v4.js','./onboarding.js','./coverage-book.js','./practical-book.js','./scope-gap-book-v4.js','./coverage-integration.js','./practical-integration.js','./cbt-integration-v4.js','./coverage-runtime-fix.js','./coverage-daily.js','./practical-daily.js','./gap-daily-v4.js','./mock-coverage.js','./mock-wave2.js','./practical-mock.js','./gap-mock-v4.js','./accrual-layout-fix.js','./asset-lab-v2.js','./dropdown-choice-fix.js','./question-variety-v2.js','./question-book.js','./question-book-player.js','./account-window-bridge.js','./ui-polish.js','./learning-map-nav.js','./account-master.js','./phrase-bank.js','./phrase-bridge.js','./manifest.json','./app-icon-v2.svg','./icon-192-v2.png','./app-icon.svg','./icon-192.png','./icon-512.png','./mascot.png','./assets/mascot.png'];
...
async function withEnhancements(res){
 ...
 const practicalPage=text.includes('実戦連結ドリル')&&text.includes('id="scenarios"');
 const gapPage=text.includes('公式再監査 補強ドリル')&&text.includes('id="list"');
 const managementPage=text.includes('学習状況を詳しく分析')&&text.includes('id="crossWeak"');
 ...
 if(practicalPage&&!text.includes('practical-sequence.js'))scripts.push('<script src="./practical-sequence.js"></script>');
 if(gapPage&&!text.includes('gap-sequence-v4.js'))scripts.push('<script src="./gap-sequence-v4.js"></script>');
 ...
 if(weightedPage&&!text.includes('mastery-gap-patch-v4.js'))scripts.push('<script src="./mastery-gap-patch-v4.js"></script>');
 ...
 if(problemBookPage&&!text.includes('official-topic-master-v4.js'))scripts.push('<script src="./official-topic-master-v4.js"></script>');
 if(homePage&&!text.includes('exam-readiness.js'))scripts.push('<script src="./exam-readiness.js"></script>');
 if(homePage&&!text.includes('cbt-readiness-v4.js'))scripts.push('<script src="./cbt-readiness-v4.js"></script>');
 ...
 if(problemBookPage&&!text.includes('scope-gap-book-v4.js'))scripts.push('<script src="./scope-gap-book-v4.js"></script>');
 ...
 if(!text.includes('cbt-integration-v4.js'))scripts.push('<script src="./cbt-integration-v4.js"></script>');
 ...
 if(dailyPage&&!text.includes('gap-daily-v4.js'))scripts.push('<script src="./gap-daily-v4.js"></script>');
 ...
 if(mockPage&&!text.includes('gap-mock-v4.js'))scripts.push('<script src="./gap-mock-v4.js"></script>');
 if(managementPage&&!text.includes('error-diagnostics-v1.js'))scripts.push('<script src="./error-diagnostics-v1.js"></script>');
 if(managementPage&&!text.includes('diagnostics-ui-v4.js'))scripts.push('<script src="./diagnostics-ui-v4.js"></script>');
