...
function loadAddon(id,src){if(document.getElementById(id))return;const s=document.createElement('script');s.id=id;s.src=src+'?v=1';document.body.appendChild(s)}
function pageAddons(){const p=current();if(p==='mock.html')loadAddon('mock-multiset-v3','mock-multiset-v3.js');if(p==='q2-cbt.html')loadAddon('q2-asset-fix-v1','q2-asset-fix-v1.js')}
function fix(){
 const html=navHtml();
