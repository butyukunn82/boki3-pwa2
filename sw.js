const CACHE='boki3-unified-v2.4.3-accrual-layout';
const ASSETS=['./','./index.html','./daily.html','./learn.html','./labs.html','./q1.html','./q2.html','./q3.html','./understand.html','./glossary.html','./management.html','./settings.html','./common.css','./mobile-app.css','./app-ui-v13.css','./app-v20.css','./unified.js','./mastery.js','./mastery-native.js','./accrual-layout-fix.js','./account-master.js','./phrase-bank.js','./phrase-bridge.js','./manifest.json','./icon-192.png','./icon-512.png','./mascot.png','./assets/mascot.png'];
...
async function withMastery(res){
 ...
 if(text.includes('labs.html')||text.includes('難所ラボ')){
