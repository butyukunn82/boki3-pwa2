const CACHE='boki3-unified-v2.5.14-weighted-mastery-explain';
...
async function withEnhancements(res){
 ...
 if(!text.includes('account-master.js'))scripts.push('<script src="./account-master.js"></script>');
 if(!text.includes('phrase-bank.js'))scripts.push('<script src="./phrase-bank.js"></script>');
 ...
 if(!text.includes('mastery-progress-v2.js'))scripts.push('<script src="./mastery-progress-v2.js"></script>');
