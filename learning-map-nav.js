...
function loadAddon(id,src){if(document.getElementById(id))return;const s=document.createElement('script');s.id=id;s.async=false;s.src=src+'?v=7';document.body.appendChild(s)}
function pageAddons(){const p=current();if(p==='mock.html'){loadAddon('mock-multiset-v3','mock-multiset-v3.js');loadAddon('mock-q2-audit-v1','mock-q2-audit-v1.js');loadAddon('mock-q3-comprehensive-v1','mock-q3-comprehensive-v1.js');loadAddon('mock-q1-pool-v4','mock-q1-pool-v4.js');loadAddon('mock-analysis-v1','mock-analysis-v1.js')}if(p==='daily.html'){loadAddon('daily-mock-rotation-policy-v2','daily-mock-rotation-policy-v2.js');loadAddon('daily-mock-priority-v1','daily-mock-priority-v1.js');loadAddon('daily-mock-review-log-v1','daily-mock-review-log-v1.js')}if(p==='management.html'){loadAddon('management-cycle-v1','management-cycle-v1.js');loadAddon('management-cycle-policy-v2','management-cycle-policy-v2.js');loadAddon('management-history-v3-fix-v1','management-history-v3-fix-v1.js')}if(p==='q2-cbt.html'){loadAddon('q2-asset-fix-v1','q2-asset-fix-v1.js');loadAddon('q2-audit-upgrade-v2','q2-audit-upgrade-v2.js');loadAddon('cbt-deeplink-v1','cbt-deeplink-v1.js')}if(p==='q3-cbt.html'){loadAddon('q3-comprehensive-v1','q3-comprehensive-v1.js');loadAddon('cbt-deeplink-v1','cbt-deeplink-v1.js')}}
function fix(){
 const html=navHtml();
